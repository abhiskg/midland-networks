...
export default function ServiceCard({ data }: { data: ServiceDataType }) {
  ...
  return (
    <div className='bg-white flex flex-col select-none sm:w-[25.1rem] w-screen h-[31rem] justify-between rounded-xl gap-5 overflow-hidden shadow-md hover:scale-[1.015] my-1 hover:shadow-lg cursor-pointer transition-transform duration-500 ease-out  '>
