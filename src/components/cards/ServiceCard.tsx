...
export default function ServiceCard({ data }: { data: ServiceDataType }) {
  ...
  return (
    <div className='bg-white flex flex-col justify-between rounded-xl gap-5 overflow-hidden h-96 shadow-md hover:scale-[1.02] hover:shadow-lg cursor-pointer transition-transform duration-300 ease-out '>
