...
export default function AwardsCarousel() {
  ...
  return (
    <div className='mt-5 mb-14 md:mb-20'>
      <Slider {...settings}>
        <div className='bg-white flex flex-col p-10 rounded-xl shadow-md mr-2 text-lg h-[240px]  '>
          <Icon5 />
        ...
        <div className='bg-white p-10 rounded-xl shadow-md mr-2 text-lg h-[240px] '>
          <Icon6 />
          <h3 className='mt-4'>2018</h3>
